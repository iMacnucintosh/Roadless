                                                              ...
                                                              Row(
                                                                children: [
                                                                  Tooltip(
                                                                    ...
                                                                    child:
                                                                        Icon(track.activityType!.icon, color: Theme.of(context).colorScheme.primary),
                                                                  ),
...
class TriangleClipper extends CustomClipper<Path> {
  ...
  Path getClip(Size size) {
    var path = Path();
    path.lineTo(0.0, size.height - 5); // Ir hasta el borde inferior izquierdo
    path.lineTo(size.width / 2, size.height); // Crear el vértice inferior
    path.lineTo(size.width, size.height - 5); // Ir hasta el borde inferior derecho
    path.lineTo(size.width, 0.0); // Borde derecho
